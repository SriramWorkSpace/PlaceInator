...
/** Placement -- a tracked outcome (assignment/checklist), distinct from
 * Outreach's GroupsIcon so the two read as different stages rather than
 * the same icon repeated. Google Material Icons (not Material Symbols --
 * the rest of this file's -960..960 grid), so it keeps its own native
 * 0..24 viewBox rather than being forced through the shared Icon() helper
 * above; same fill="currentColor" convention as everywhere else in this
 * file, replacing the source's hardcoded #e3e3e3. */
export function PlacementIcon(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="20"
...
/** Settings: Appearance section (theme + palette). */
...
/** Settings: Account/credentials section. */
